        ...
        try {
            ...
            if (isSimulation) {
                ...
                for (const group of visionGroups) {
                    ...
                    const visionModel = modelSettings?.openai || 'gpt-5.2-2025-12-11';
                ...
                try {
                    ...
                    const orchestratorResult = await runPerplexityDirectedLoop({
                        ...
                        openaiParams: {
                            ...
                            model: modelSettings.openai || 'gpt-5.2-2025-12-11',
                        },
                    ...
                    return {
                        ...
                        sport: sport,
                        model_used: modelSettings.openai || 'gpt-5.2-2025-12-11',
